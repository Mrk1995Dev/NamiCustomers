...
namespace NamiCustomers.Persistence.Migrations
{
    ...
    [Migration("20250527055558_remove_subscriber_dealer")]
    partial class remove_subscriber_dealer
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("NamiCustomers.Domain.Entities.Security.ApplicationUser", b =>
                {
                    b.Property<string>("Id")
                        .HasColumnType("nvarchar(450)");
            ...
            modelBuilder.Entity("NamiCustomers.Domain.Entities.Subscribers.Subscriber", b =>
                {
                    ...
                    b.HasIndex("NatinalCode")
                        .IsUnique()
                        .HasFilter("[NatinalCode] IS NOT NULL");
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("NamiCustomers.Domain.Entities.Security.ApplicationUser", null)
                        .WithMany()
